...
export function AdminThemeProvider({ children }) {
    ...
    const theme = useMemo(() => ({
        ...
        sidebarTextTitle: isDarkMode ? 'text-white' : 'text-slate-800',
        sidebarTextSub: isDarkMode ? 'text-blue-100/80' : 'text-slate-600',
        sidebarTextDesc: isDarkMode ? 'text-blue-200/60' : 'text-slate-500',
