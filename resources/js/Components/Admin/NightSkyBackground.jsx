...
export default function NightSkyBackground() {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none bg-gradient-to-b from-[#0b0f17] via-[#0e1420] to-[#080b11]">
            ...
            {/* Comet */}
            <div
                className="absolute w-28 h-[2.5px] bg-gradient-to-r from-white via-blue-300/40 to-transparent rounded-full shadow-[0_0_8px_rgba(147,197,253,0.55)] origin-left comet-glow"
                style={{
                    top: '12%',
                    left: '5%',
                }}
