                ...
                <div className="flex gap-2 mt-3 px-3 pb-2 border-b border-zinc-150/60 dark:border-zinc-800/60">
                    {customer?.phone_number && (
                        <a
                            ...
                            className="flex-1 py-1.5 px-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-bold text-[9px] text-center flex items-center justify-center gap-1.5 transition-colors cursor-pointer select-none"
                        >
                    ...
                    {customer?.latitude && customer?.longitude && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 py-1.5 px-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-bold text-[9px] text-center flex items-center justify-center gap-1.5 transition-colors cursor-pointer select-none"
                        >
                            <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
