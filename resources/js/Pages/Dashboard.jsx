...
function SidebarPanel({
    ...
    return (
        <>
            ...
            <div className={`p-3 ${themeSidebarBottom} transition-colors duration-200`}>
...
export default function Dashboard({ 
    ...
    useEffect(() => {
        const handlePopState = () => {
            ...
            const validTabs = ['dashboard', 'routers', 'customers', 'packages', 'invoices', 'hotspot', 'settings', 'profile', 'network-map'];
    ...
    return (
        <>
            ...
            <div className={`flex h-screen overflow-hidden font-sans antialiased transition-colors duration-250 ${themeBg}`}>
                ...
                <aside className={`hidden md:flex flex-col w-56 shrink-0 transition-colors duration-250 ${themeSidebar}`}>
                    <SidebarPanel
                        branding={branding}
                        auth={auth}
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <AppFooter
                        branding={branding}
                        className={`shrink-0 px-4 sm:px-6 py-2.5 border-t text-center ${isDarkMode ? 'border-zinc-800/80 bg-zinc-950/30' : 'border-zinc-200 bg-white/80'}`}
