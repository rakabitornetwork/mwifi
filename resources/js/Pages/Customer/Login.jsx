...
export default function CustomerLogin({ phone: initialPhone = '', otp_sent: otpSent = false, masked_phone: maskedPhone = null }) {
    ...
    return (
        <>
            ...
            <PullToRefresh useWindowScroll isDarkMode className="min-h-screen flex flex-col bg-slate-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-950/20 via-slate-950 to-slate-950 font-sans">
