...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $defaultSettings = [
            ...
            ['group' => 'payment', 'key' => 'payment.midtrans.mode', 'value' => 'sandbox', 'is_encrypted' => false],
            ...
            ['group' => 'payment', 'key' => 'payment.tripay.mode', 'value' => 'sandbox', 'is_encrypted' => false],
            ...
            ['group' => 'whatsapp', 'key' => 'whatsapp.enabled', 'value' => '1', 'is_encrypted' => false],
            ...
            ['group' => 'whatsapp', 'key' => 'whatsapp.bulk_batch_size', 'value' => '5', 'is_encrypted' => false],
            ['group' => 'whatsapp', 'key' => 'whatsapp.bulk_window_seconds', 'value' => '300', 'is_encrypted' => false],
