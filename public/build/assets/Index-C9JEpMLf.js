import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{Ft as t,ht as n,t as r}from"./vendor-BXfUUSDP.js";import{L as i,bt as a,f as o,j as s,m as c,t as l,x as u}from"./vendor-core-Hw6UvLyG.js";import{t as d}from"./formatRupiah-BPNt29Go.js";import{n as f,r as p,t as m}from"./AdminLayout-wvrJ2qvq.js";import{n as h,t as g}from"./ModalFormActions-D7kvVejY.js";import{n as _,t as v}from"./GpsCoordinateFields-DlSZun-Z.js";var y=e(t(),1),b=e(r(),1);function x(e){if(!e)return{down:0,up:0};let t=String(e).split(`/`),n=e=>{let t=String(e||``).trim().toUpperCase(),n=parseFloat(t);return Number.isNaN(n)?0:t.includes(`G`)?n*1e3:t.includes(`K`)?n/1e3:n};return{down:n(t[0]),up:n(t[1]??t[0])}}function S(e,t){if(!t)return{};let n=e?.ont||{},r=[t,String(t).split(`@`)[0],String(t).toLowerCase(),String(t).split(`@`)[0].toLowerCase()];for(let e of r)if(e&&n[e])return n[e];let i=String(t).toLowerCase(),a=i.split(`@`)[0];for(let[e,t]of Object.entries(n)){let n=String(e).toLowerCase(),r=n.split(`@`)[0];if(n===i||r===a)return t}return(e?.ont_devices||[]).find(e=>{let t=String(e.username||``).toLowerCase();return!t||t===`unknown_ont`?!1:t===i||t.split(`@`)[0]===a})||{}}function C(e,t){let n=t?.username;if(!n)return{};let r=e?.traffic_by_router?.[String(t.router_id)]||e?.traffic_by_router?.[t.router_id]||e?.traffic||{},i=[n,String(n).split(`@`)[0],String(n).toLowerCase(),String(n).split(`@`)[0].toLowerCase()];for(let e of i)if(e&&r[e])return r[e];let a=String(n).toLowerCase(),o=a.split(`@`)[0];for(let[e,t]of Object.entries(r)){let n=String(e).toLowerCase(),r=n.split(`@`)[0];if(n===a||r===o)return t}return{}}function w(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function T(e,t=`neutral`){return`<span class="map-popup-badge map-popup-badge--${t}">${w(e)}</span>`}function E(e,t,n=``){return`
    ...
    `}function z({odps:e=[],customers:t=[]}){let r=f(),{showToast:a}=p(),{isDarkMode:d,themeCard:m,themeTextTitle:x,themeTextSub:S}=r,C=d?`bg-zinc-950/40 border-zinc-900`:`bg-zinc-50 border-zinc-200/60`,w=d?`bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700`:`bg-white border-zinc-200 text-zinc-800 focus:border-zinc-300`,T=d?`text-zinc-400`:`text-zinc-650`,[E,D]=(0,y.useState)(!1),[O,k]=(0,y.useState)(null),[A,j]=(0,y.useState)(``),[z,B]=(0,y.useState)(``),[V,H]=(0,y.useState)(``),[U,W]=(0,y.useState)({ont:{},traffic:{}}),G=(0,y.useRef)(null),K=(0,y.useRef)({}),q=(0,y.useRef)(null),J=(0,y.useRef)(U);J.current=U,(0,y.useEffect)(()=>{E&&(B(O?String(O.latitude):``),H(O?String(O.longitude):``))},[E,O]);let Y=async()=>{try{W(await(await fetch(`/admin/network-map/metrics`)).json())}catch(e){console.error(`Failed to load network map metrics`,e)}};(0,y.useEffect)(()=>{Y();let e=setInterval(Y,15e3);return()=>clearInterval(e)},[]),(0,y.useEffect)(()=>{let e=q.current;if(!e)return;let n=K.current[e],r=t.find(t=>t.id===e);n&&r&&n.isPopupOpen()&&n.setPopupContent(N(r,U))},[U,t]);let X=e=>{G.current&&e.latitude&&e.longitude&&G.current.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{animate:!0,duration:1.2})},Z=e=>{e.preventDefault();let t=new FormData(e.target),r=Object.fromEntries(t.entries());n.post(`/admin/odps/save`,r,{onSuccess:()=>{D(!1),k(null)}})},ee=e=>{confirm(`Apakah Anda yakin ingin menghapus ODP "${e.name}"? Tindakan ini tidak dapat dibatalkan.`)&&n.post(`/admin/odps/delete`,{id:e.id})},Q=e.filter(e=>e.name.toLowerCase().includes(A.toLowerCase())||e.description&&e.description.toLowerCase().includes(A.toLowerCase()));(0,y.useEffect)(()=>{if(!document.getElementById(`map-container`))return;let r=e.length>0?[parseFloat(e[0].latitude),parseFloat(e[0].longitude)]:[-6.3263,108.3201],i=b.default.map(`map-container`,{center:r,zoom:15,zoomControl:!1,layers:[]});G.current=i,b.default.control.zoom({position:`topright`}).addTo(i);let o=e=>{let{lat:t,lng:n}=e;B(t.toFixed(6)),H(n.toFixed(6)),k(null),b.default.popup().setLatLng(e).setContent(R(t,n)).openOn(i)};i.on(`contextmenu`,e=>{b.default.DomEvent.preventDefault(e.originalEvent),I()||o(e.latlng)});let s=null,c=()=>{s!==null&&(clearTimeout(s),s=null)},l=e=>{if(!I()||e.touches.length!==1)return;let t=e.touches[0];c(),s=setTimeout(()=>{s=null;let e=i.mouseEventToContainerPoint({clientX:t.clientX,clientY:t.clientY}),n=i.containerPointToLatLng(e);navigator.vibrate?.(40),o(n)},L)},u=()=>c(),f=()=>c(),p=()=>c(),m=i.getContainer();m.addEventListener(`touchstart`,l,{passive:!0}),m.addEventListener(`touchmove`,u,{passive:!0}),m.addEventListener(`touchend`,f,{passive:!0}),m.addEventListener(`touchcancel`,p,{passive:!0}),i.on(`popupopen`,e=>{let t=e.popup.getElement();if(!t)return;let r=t.querySelector(`#mini-odp-form`);if(r){setTimeout(()=>{let e=r.querySelector(`#mini-odp-name`);e&&e.focus()},100),r.addEventListener(`submit`,e=>{e.preventDefault();let t=r.querySelector(`#mini-odp-name`).value,a=r.querySelector(`#mini-odp-ports`).value,o=r.querySelector(`#mini-odp-desc`).value,s=r.querySelector(`#mini-odp-lat`).value,c=r.querySelector(`#mini-odp-lng`).value;n.post(`/admin/odps/save`,{name:t,latitude:s,longitude:c,total_ports:a,description:o},{onSuccess:()=>{i.closePopup()}})});let e=r.querySelector(`#mini-odp-gps-btn`);e&&e.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`Membaca GPS...`;try{let e=await _(),t=r.querySelector(`#mini-odp-lat`),n=r.querySelector(`#mini-odp-lng`);t&&(t.value=e.latitude),n&&(n.value=e.longitude),B(e.latitude),H(e.longitude),i.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{duration:.8}),a(`Koordinat GPS berhasil diambil.`,`success`)}catch(e){a(e.message||`Gagal membaca GPS perangkat.`,`error`)}finally{e.disabled=!1,e.textContent=`Ambil GPS Perangkat`}})}});let h=d?`https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png`:`https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png`;b.default.tileLayer(h,{attribution:`© OpenStreetMap`}).addTo(i);let g=b.default.divIcon({className:`custom-odp-marker`,html:`<div class="w-6 h-6 rounded-full bg-blue-500 border-2 border-white dark:border-zinc-950 flex items-center justify-center text-[8px] font-black text-white shadow-lg ring-2 ring-blue-500/25">ODP</div>`,iconSize:[24,24],iconAnchor:[12,12]}),v=e=>b.default.divIcon({className:`custom-customer-marker`,html:`<div class="w-3.5 h-3.5 rounded-full ${e===`active`?`bg-emerald-500 ring-emerald-500/35`:`bg-rose-500 ring-rose-500/35`} border border-white dark:border-zinc-950 shadow-md ring-2"></div>`,iconSize:[14,14],iconAnchor:[7,7]}),y={};e.forEach(e=>{let t=parseFloat(e.latitude),n=parseFloat(e.longitude);y[e.id]=[t,n],b.default.marker([t,n],{icon:g}).addTo(i).bindPopup(`
                ...
                `)}),K.current={},t.forEach(e=>{if(!F(e)||!e.latitude||!e.longitude)return;let t=parseFloat(e.latitude),n=parseFloat(e.longitude),r=b.default.marker([t,n],{icon:v(e.status)}).addTo(i).bindPopup(()=>N(e,J.current),M());if(r.on(`popupopen`,()=>{q.current=e.id,r.setPopupContent(N(e,J.current))}),r.on(`popupclose`,()=>{q.current===e.id&&(q.current=null)}),K.current[e.id]=r,e.odp_id&&y[e.odp_id]){let r=y[e.odp_id],a=[t,n],o=e.status===`active`?`#10b981`:`#f59e0b`;b.default.polyline([r,a],{color:o,weight:2,opacity:.75,className:`optical-cable-flow`,smoothFactor:0}).addTo(i)}});let x=2400,S=performance.now(),C=null,w=e=>{let t=-((e-S)%x/x)*20;i.getPane(`overlayPane`)?.querySelectorAll(`path.optical-cable-flow`).forEach(e=>{e.style.strokeDashoffset=`${t}`}),C=requestAnimationFrame(w)};return C=requestAnimationFrame(w),()=>{C!==null&&cancelAnimationFrame(C),c(),m.removeEventListener(`touchstart`,l),m.removeEventListener(`touchmove`,u),m.removeEventListener(`touchend`,f),m.removeEventListener(`touchcancel`,p),G.current=null,i.remove()}},[e,t,d,a]);let $=()=>{D(!1),k(null)};return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(`div`,{className:`${m} border rounded-2xl p-5 space-y-4`,children:[(0,P.jsxs)(`div`,{className:`flex flex-col sm:flex-row justify-between items-start sm:items-center border-b ${d?`border-zinc-800/40`:`border-zinc-200/80`} pb-3 gap-3`,children:[(0,P.jsxs)(`div`,{className:`flex items-center space-x-2`,children:[(0,P.jsx)(i,{className:`w-5 h-5 text-emerald-500`}),(0,P.jsx)(`h2`,{className:`text-sm font-bold ${x}`,children:`Peta Jaringan Pelanggan & ODP`})]}),(0,P.jsx)(`span`,{className:`text-[10px] text-zinc-500 font-bold`,children:`Teknologi Optical Distribution Point (ODP)`})]}),(0,P.jsxs)(`div`,{className:`flex flex-col lg:flex-row gap-5`,children:[(0,P.jsxs)(`div`,{className:`w-full lg:w-80 xl:w-96 flex flex-col space-y-3 flex-shrink-0`,children:[(0,P.jsxs)(`div`,{className:`flex justify-between items-center`,children:[(0,P.jsxs)(`h3`,{className:`text-xs font-bold ${x}`,children:[`Daftar ODP (`,Q.length,`)`]}),(0,P.jsx)(`button`,{type:`button`,onClick:()=>{k(null),D(!0)},title:`Tambah ODP`,className:`p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg cursor-pointer inline-flex items-center justify-center transition-colors`,children:(0,P.jsx)(s,{className:`w-4 h-4`})})]}),(0,P.jsxs)(`div`,{className:`relative`,children:[(0,P.jsx)(`input`,{type:`text`,placeholder:`Cari ODP...`,value:A,onChange:e=>j(e.target.value),className:`w-full p-2 pl-8 border rounded-lg text-xs ${w}`}),(0,P.jsx)(u,{className:`w-3.5 h-3.5 text-zinc-500 absolute left-2.5 top-3`})]}),(0,P.jsx)(`div`,{className:`max-h-[500px] overflow-y-auto space-y-2 pr-1`,children:Q.length===0?(0,P.jsx)(`div`,{className:`text-center py-8 text-xs ${S} ${C} rounded-xl border border-dashed`,children:`Tidak ada ODP ditemukan`}):Q.map(e=>{let n=e.customers_count??t.filter(t=>t.odp_id===e.id).length,r=n>=e.total_ports;return(0,P.jsxs)(`div`,{onClick:()=>X(e),className:`p-3 rounded-xl border transition-all duration-150 cursor-pointer flex justify-between items-start gap-2 ${d?`bg-zinc-950/40 border-zinc-900 hover:bg-zinc-900/60 hover:border-zinc-800`:`bg-zinc-50/50 border-zinc-150 hover:bg-zinc-100/60 hover:border-zinc-200`}`,children:[(0,P.jsxs)(`div`,{className:`space-y-1 min-w-0 flex-1`,children:[(0,P.jsxs)(`div`,{className:`flex items-center gap-1.5`,children:[(0,P.jsx)(`div`,{className:`w-2 h-2 rounded-full ${r?`bg-rose-500`:`bg-blue-500`}`}),(0,P.jsx)(`span`,{className:`text-xs font-bold truncate ${x}`,children:e.name})]}),(0,P.jsx)(`p`,{className:`text-[10px] text-zinc-500 dark:text-zinc-400 font-semibold truncate`,children:e.description||`Tidak ada deskripsi lokasi`}),(0,P.jsxs)(`div`,{className:`flex items-center gap-2 text-[10px] font-medium text-zinc-500 dark:text-zinc-450 mt-1`,children:[(0,P.jsxs)(`span`,{className:`px-1.5 py-0.5 rounded-md ${r?`bg-rose-500/10 text-rose-500 dark:text-rose-400`:`bg-blue-500/10 text-blue-600 dark:text-blue-400`}`,children:[`Port: `,n,` / `,e.total_ports]}),(0,P.jsxs)(`span`,{className:`font-mono text-[9px]`,children:[parseFloat(e.latitude).toFixed(5),`, `,parseFloat(e.longitude).toFixed(5)]})]})]}),(0,P.jsxs)(`div`,{className:`flex items-center gap-1 flex-shrink-0`,onClick:e=>e.stopPropagation(),children:[(0,P.jsx)(`button`,{type:`button`,onClick:()=>{k(e),D(!0)},className:`inline-block p-1 text-emerald-500 hover:text-emerald-400 cursor-pointer transition-colors`,title:`Edit ODP`,children:(0,P.jsx)(c,{className:`w-4 h-4`})}),(0,P.jsx)(`button`,{type:`button`,onClick:()=>ee(e),className:`inline-block p-1 text-rose-500 hover:text-rose-400 cursor-pointer transition-colors`,title:`Hapus ODP`,children:(0,P.jsx)(o,{className:`w-4 h-4`})})]})]},e.id)})})]}),(0,P.jsxs)(`div`,{className:`flex-1 flex flex-col space-y-2`,children:[(0,P.jsx)(`p`,{className:`text-xs text-zinc-500 dark:text-zinc-400`,children:`Peta di bawah menggambarkan jalur kabel fiber optik dari masing-masing kotak ODP (biru) ke titik rumah pelanggan (hijau: aktif, merah: nonaktif).`}),(0,P.jsx)(`p`,{className:`text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 sm:hidden`,children:`Tahan posisi di peta untuk tambah ODP`}),(0,P.jsxs)(`div`,{className:`border rounded-2xl overflow-hidden shadow-xs relative ${d?`border-zinc-800/80`:`border-zinc-200`}`,children:[(0,P.jsx)(`div`,{id:`map-container`,className:`h-[550px] w-full z-0`}),(0,P.jsxs)(`div`,{className:`absolute bottom-2.5 right-2.5 z-[400] bg-zinc-950/85 border border-zinc-800/60 backdrop-blur-xs px-2.5 py-1.5 rounded-lg flex gap-3 text-[9px] font-bold text-zinc-400 shadow-md`,children:[(0,P.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,P.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-blue-500`}),` ODP`]}),(0,P.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,P.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-emerald-500`}),` Aktif`]}),(0,P.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,P.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-rose-500`}),` Nonaktif`]})]})]})]})]})]}),(0,P.jsxs)(h,{show:E,onClose:$,themeCard:m,maxWidth:`md`,children:[(0,P.jsxs)(`div`,{className:`flex justify-between items-center pb-2 border-b ${d?`border-zinc-800/40`:`border-zinc-200/80`}`,children:[(0,P.jsx)(`h3`,{className:`text-sm font-bold ${x}`,children:O?`Edit Kotak ODP`:`Tambah Kotak ODP`}),(0,P.jsx)(`button`,{type:`button`,onClick:$,className:`text-zinc-500 hover:text-white transition-colors cursor-pointer`,children:(0,P.jsx)(l,{className:`w-4 h-4`})})]}),(0,P.jsxs)(`form`,{onSubmit:Z,className:`space-y-3 text-xs pb-14 sm:pb-0`,children:[(0,P.jsx)(`input`,{type:`hidden`,name:`id`,value:O?O.id:``}),(0,P.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,P.jsx)(`label`,{className:`font-bold ${T}`,children:`Nama ODP`}),(0,P.jsx)(`input`,{required:!0,name:`name`,type:`text`,placeholder:`Contoh: ODP-JBG-01`,defaultValue:O?O.name:``,className:`p-2 border rounded-lg ${w}`})]}),(0,P.jsx)(v,{latitude:z,longitude:V,onLatitudeChange:B,onLongitudeChange:H,themeInput:w,themeLabel:T,isDarkMode:d,required:!0,inputType:`number`,onError:e=>a(e,`error`),onSuccess:()=>a(`Koordinat GPS berhasil diambil.`,`success`)}),(0,P.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,P.jsx)(`label`,{className:`font-bold ${T}`,children:`Jumlah Port Total`}),(0,P.jsx)(`input`,{required:!0,name:`total_ports`,type:`number`,min:`1`,placeholder:`8`,defaultValue:O?O.total_ports:8,className:`p-2 border rounded-lg ${w}`})]}),(0,P.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,P.jsx)(`label`,{className:`font-bold ${T}`,children:`Deskripsi Lokasi / Keterangan`}),(0,P.jsx)(`textarea`,{name:`description`,placeholder:`Dekat tiang listrik depan toko A...`,defaultValue:O?O.description:``,className:`p-2 border rounded-lg h-20 resize-none ${w}`})]}),(0,P.jsxs)(`div`,{className:`p-2.5 ${C} rounded-xl text-[10px] ${S} leading-normal`,children:[`💡 `,(0,P.jsx)(`strong`,{className:x,children:`Tips:`}),` Klik kanan peta (desktop) atau tahan posisi di peta (HP), gunakan tombol GPS perangkat, atau isi koordinat manual.`]}),(0,P.jsx)(g,{isDarkMode:d,onCancel:$})]})]})]})}function B({odps:e,customers:t}){return(0,P.jsx)(m,{title:`Peta Jaringan`,children:(0,P.jsx)(z,{odps:e,customers:t})})}export{B as default};