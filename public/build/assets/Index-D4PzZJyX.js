import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{Ft as t,ht as n,t as r}from"./vendor-BXfUUSDP.js";import{$t as i,A as a,X as o,_ as s,b as c,j as l,n as u,z as d}from"./vendor-core-BdAy7cNf.js";import{t as f}from"./formatRupiah-BPNt29Go.js";import{i as p,n as m,r as h,t as g}from"./AdminLayout-DOXNlkOx.js";import{n as _}from"./useAdminToast-zNP2_Cvp.js";import{t as v}from"./AdminPageCard-yAHjGuWB.js";import{t as y}from"./TransitionModal-Btcnj0jH.js";import{a as b,i as x,n as S,r as C}from"./customerMetrics-CA4_Rpq8.js";import{n as ee,t as te}from"./GpsCoordinateFields-DQGKmm5W.js";var w=e(t(),1),T=e(r(),1);function E(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function D(e,t=`neutral`){return`<span class="map-popup-badge map-popup-badge--${t}">${E(e)}</span>`}function O(e,t,n=``){return`
    ...
    `}var I=i(),ne=e=>e?.service_type!==`hotspot`;function L({odps:e=[],customers:t=[]}){let r=h(),{showToast:i}=_(),{canWrite:f}=p(),{isDarkMode:g,themeCard:x,themeTextTitle:S,themeTextSub:C,themeTextDesc:E}=r,D=g?`bg-zinc-950/40 border-zinc-900`:`bg-zinc-50 border-zinc-200/60`,O=g?`bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700`:`bg-white border-zinc-200 text-zinc-800 focus:border-zinc-300`,k=g?`text-zinc-400`:`text-zinc-650`,[A,j]=(0,w.useState)(!1),[M,N]=(0,w.useState)(null),[L,R]=(0,w.useState)(``),[z,B]=(0,w.useState)(``),[V,H]=(0,w.useState)(``),[U,re]=(0,w.useState)({ont:{},traffic:{}}),[W,G]=(0,w.useState)(null),ie={canWrite:f},K=(0,w.useRef)(null),q=(0,w.useRef)({}),J=(0,w.useRef)(null),Y=(0,w.useRef)(U);Y.current=U;let X=(0,w.useRef)(f);X.current=f,(0,w.useEffect)(()=>{A&&(B(M?String(M.latitude):``),H(M?String(M.longitude):``))},[A,M]);let Z=async()=>{try{re(await(await fetch(`/admin/network-map/metrics`)).json())}catch(e){console.error(`Failed to load network map metrics`,e)}};(0,w.useEffect)(()=>{Z();let e=setInterval(Z,15e3);return()=>clearInterval(e)},[]),(0,w.useEffect)(()=>{let e=J.current;if(!e)return;let n=q.current[e],r=t.find(t=>t.id===e);n&&r&&n.isPopupOpen()&&n.setPopupContent(F(r,U,ie))},[U,t,f]);let ae=e=>{K.current&&e.latitude&&e.longitude&&K.current.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{animate:!0,duration:1.2})},oe=e=>{e.preventDefault();let t=new FormData(e.target),r=Object.fromEntries(t.entries());n.post(`/admin/odps/save`,r,{onSuccess:()=>{j(!1),N(null)}})},se=e=>{confirm(`Apakah Anda yakin ingin menghapus ODP "${e.name}"? Tindakan ini tidak dapat dibatalkan.`)&&n.post(`/admin/odps/delete`,{id:e.id})},Q=e.filter(e=>e.name.toLowerCase().includes(L.toLowerCase())||e.description&&e.description.toLowerCase().includes(L.toLowerCase()));(0,w.useEffect)(()=>{if(!document.getElementById(`map-container`))return;let r=e.length>0?[parseFloat(e[0].latitude),parseFloat(e[0].longitude)]:[-6.3263,108.3201],a=T.default.map(`map-container`,{center:r,zoom:15,zoomControl:!1,layers:[]});K.current=a,T.default.control.zoom({position:`topright`}).addTo(a);let o=(e,t)=>`
                ...
                `,s=e=>{if(!X.current)return;let{lat:t,lng:n}=e;B(t.toFixed(6)),H(n.toFixed(6)),N(null),T.default.popup().setLatLng(e).setContent(o(t,n)).openOn(a)};a.on(`contextmenu`,e=>{T.default.DomEvent.preventDefault(e.originalEvent),s(e.latlng)});let c=a.getContainer(),l=null,u=null,d=()=>{l!==null&&(clearTimeout(l),l=null),u=null},f=e=>{if(e.touches.length!==1){d();return}let t=e.touches[0];u={x:t.clientX,y:t.clientY,touch:t},l=window.setTimeout(()=>{if(l=null,!u)return;let{touch:e}=u;s(a.containerPointToLatLng(a.mouseEventToContainerPoint({clientX:e.clientX,clientY:e.clientY}))),navigator.vibrate?.(40),u=null},600)},p=e=>{if(!u||l===null)return;let t=e.touches[0],n=t.clientX-u.x,r=t.clientY-u.y;Math.hypot(n,r)>12&&d()},m=()=>{d()};c.addEventListener(`touchstart`,f,{passive:!0}),c.addEventListener(`touchmove`,p,{passive:!0}),c.addEventListener(`touchend`,m),c.addEventListener(`touchcancel`,m),a.on(`popupopen`,e=>{let r=e.popup.getElement();if(!r)return;let o=r.querySelector(`.map-popup-wifi-edit-btn`);o&&!o.dataset.bound&&(o.dataset.bound=`1`,o.addEventListener(`click`,()=>{let e=Number(o.dataset.customerId),n=t.find(t=>t.id===e);n&&G(n)}));let s=r.querySelector(`#mini-odp-form`);if(s){setTimeout(()=>{let e=s.querySelector(`#mini-odp-name`);e&&e.focus()},100),s.addEventListener(`submit`,e=>{if(e.preventDefault(),!X.current)return;let t=s.querySelector(`#mini-odp-name`).value,r=s.querySelector(`#mini-odp-ports`).value,i=s.querySelector(`#mini-odp-desc`).value,o=s.querySelector(`#mini-odp-lat`).value,c=s.querySelector(`#mini-odp-lng`).value;n.post(`/admin/odps/save`,{name:t,latitude:o,longitude:c,total_ports:r,description:i},{onSuccess:()=>{a.closePopup()}})});let e=s.querySelector(`#mini-odp-gps-btn`);e&&e.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`Membaca GPS...`;try{let e=await ee(),t=s.querySelector(`#mini-odp-lat`),n=s.querySelector(`#mini-odp-lng`);t&&(t.value=e.latitude),n&&(n.value=e.longitude),B(e.latitude),H(e.longitude),a.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{duration:.8}),i(`Koordinat GPS berhasil diambil.`,`success`)}catch(e){i(e.message||`Gagal membaca GPS perangkat.`,`error`)}finally{e.disabled=!1,e.textContent=`Ambil GPS Perangkat`}})}});let h=g?`https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png`:`https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png`;T.default.tileLayer(h,{attribution:`© OpenStreetMap`}).addTo(a);let _=T.default.divIcon({className:`custom-odp-marker`,html:`<div class="w-6 h-6 rounded-full bg-blue-500 border-2 border-white dark:border-zinc-950 flex items-center justify-center text-[8px] font-black text-white shadow-lg ring-2 ring-blue-500/25">ODP</div>`,iconSize:[24,24],iconAnchor:[12,12]}),v=e=>T.default.divIcon({className:`custom-customer-marker`,html:`<div class="w-3.5 h-3.5 rounded-full ${e===`active`?`bg-emerald-500 ring-emerald-500/35`:`bg-rose-500 ring-rose-500/35`} border border-white dark:border-zinc-950 shadow-md ring-2"></div>`,iconSize:[14,14],iconAnchor:[7,7]}),y={};e.forEach(e=>{let t=parseFloat(e.latitude),n=parseFloat(e.longitude);y[e.id]=[t,n],T.default.marker([t,n],{icon:_}).addTo(a).bindPopup(`
