import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{Ft as t,ht as n,t as r}from"./vendor-BXfUUSDP.js";import{L as i,O as a,g as o,k as s,n as c,q as l,qt as u,v as d}from"./vendor-core-D922lV3_.js";import{t as f}from"./formatRupiah-BPNt29Go.js";import{a as p,i as m,n as h,r as g,t as _}from"./AdminLayout-DPdxM5Cd.js";import{t as v}from"./AdminPageCard-CqzmEoVn.js";import{t as y}from"./TransitionModal-BzPWoQhf.js";import{n as ee,t as b}from"./GpsCoordinateFields-CYZGWTPA.js";var x=e(t(),1),S=e(r(),1);function C(e){if(!e)return{down:0,up:0};let t=String(e).split(`/`),n=e=>{let t=String(e||``).trim().toUpperCase(),n=parseFloat(t);return Number.isNaN(n)?0:t.includes(`G`)?n*1e3:t.includes(`K`)?n/1e3:n};return{down:n(t[0]),up:n(t[1]??t[0])}}function w(e,t){if(!t)return{};let n=e?.ont||{},r=[t,String(t).split(`@`)[0],String(t).toLowerCase(),String(t).split(`@`)[0].toLowerCase()];for(let e of r)if(e&&n[e])return n[e];let i=String(t).toLowerCase(),a=i.split(`@`)[0];for(let[e,t]of Object.entries(n)){let n=String(e).toLowerCase(),r=n.split(`@`)[0];if(n===i||r===a)return t}return(e?.ont_devices||[]).find(e=>{let t=String(e.username||``).toLowerCase();return!t||t===`unknown_ont`?!1:t===i||t.split(`@`)[0]===a})||{}}function T(e,t){let n=t?.username;if(!n)return{};let r=e?.traffic_by_router?.[String(t.router_id)]||e?.traffic_by_router?.[t.router_id]||e?.traffic||{},i=[n,String(n).split(`@`)[0],String(n).toLowerCase(),String(n).split(`@`)[0].toLowerCase()];for(let e of i)if(e&&r[e])return r[e];let a=String(n).toLowerCase(),o=a.split(`@`)[0];for(let[e,t]of Object.entries(r)){let n=String(e).toLowerCase(),r=n.split(`@`)[0];if(n===a||r===o)return t}return{}}function E(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function D(e,t=`neutral`){return`<span class="map-popup-badge map-popup-badge--${t}">${E(e)}</span>`}function O(e,t,n=``){return`
    ...
    `}var I=u(),L=e=>e?.service_type!==`hotspot`;function R({odps:e=[],customers:t=[]}){let r=m(),{showToast:u}=h(),{canWrite:f}=p(),{isDarkMode:_,themeCard:C,themeTextTitle:w,themeTextSub:T,themeTextDesc:E}=r,D=_?`bg-zinc-950/40 border-zinc-900`:`bg-zinc-50 border-zinc-200/60`,O=_?`bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700`:`bg-white border-zinc-200 text-zinc-800 focus:border-zinc-300`,k=_?`text-zinc-400`:`text-zinc-650`,[A,j]=(0,x.useState)(!1),[M,N]=(0,x.useState)(null),[R,z]=(0,x.useState)(``),[B,V]=(0,x.useState)(``),[H,U]=(0,x.useState)(``),[W,G]=(0,x.useState)({ont:{},traffic:{}}),K=(0,x.useRef)(null),q=(0,x.useRef)({}),J=(0,x.useRef)(null),Y=(0,x.useRef)(W);Y.current=W;let X=(0,x.useRef)(f);X.current=f,(0,x.useEffect)(()=>{A&&(V(M?String(M.latitude):``),U(M?String(M.longitude):``))},[A,M]);let Z=async()=>{try{G(await(await fetch(`/admin/network-map/metrics`)).json())}catch(e){console.error(`Failed to load network map metrics`,e)}};(0,x.useEffect)(()=>{Z();let e=setInterval(Z,15e3);return()=>clearInterval(e)},[]),(0,x.useEffect)(()=>{let e=J.current;if(!e)return;let n=q.current[e],r=t.find(t=>t.id===e);n&&r&&n.isPopupOpen()&&n.setPopupContent(F(r,W))},[W,t]);let te=e=>{K.current&&e.latitude&&e.longitude&&K.current.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{animate:!0,duration:1.2})},ne=e=>{e.preventDefault();let t=new FormData(e.target),r=Object.fromEntries(t.entries());n.post(`/admin/odps/save`,r,{onSuccess:()=>{j(!1),N(null)}})},re=e=>{confirm(`Apakah Anda yakin ingin menghapus ODP "${e.name}"? Tindakan ini tidak dapat dibatalkan.`)&&n.post(`/admin/odps/delete`,{id:e.id})},Q=e.filter(e=>e.name.toLowerCase().includes(R.toLowerCase())||e.description&&e.description.toLowerCase().includes(R.toLowerCase()));(0,x.useEffect)(()=>{if(!document.getElementById(`map-container`))return;let r=e.length>0?[parseFloat(e[0].latitude),parseFloat(e[0].longitude)]:[-6.3263,108.3201],i=S.default.map(`map-container`,{center:r,zoom:15,zoomControl:!1,layers:[]});K.current=i,S.default.control.zoom({position:`topright`}).addTo(i);let a=(e,t)=>`
                ...
                `,o=e=>{if(!X.current)return;let{lat:t,lng:n}=e;V(t.toFixed(6)),U(n.toFixed(6)),N(null),S.default.popup().setLatLng(e).setContent(a(t,n)).openOn(i)};i.on(`contextmenu`,e=>{S.default.DomEvent.preventDefault(e.originalEvent),o(e.latlng)});let s=i.getContainer(),c=null,l=null,d=()=>{c!==null&&(clearTimeout(c),c=null),l=null},f=e=>{if(e.touches.length!==1){d();return}let t=e.touches[0];l={x:t.clientX,y:t.clientY,touch:t},c=window.setTimeout(()=>{if(c=null,!l)return;let{touch:e}=l;o(i.containerPointToLatLng(i.mouseEventToContainerPoint({clientX:e.clientX,clientY:e.clientY}))),navigator.vibrate?.(40),l=null},600)},p=e=>{if(!l||c===null)return;let t=e.touches[0],n=t.clientX-l.x,r=t.clientY-l.y;Math.hypot(n,r)>12&&d()},m=()=>{d()};s.addEventListener(`touchstart`,f,{passive:!0}),s.addEventListener(`touchmove`,p,{passive:!0}),s.addEventListener(`touchend`,m),s.addEventListener(`touchcancel`,m),i.on(`popupopen`,e=>{let t=e.popup.getElement();if(!t)return;let r=t.querySelector(`#mini-odp-form`);if(r){setTimeout(()=>{let e=r.querySelector(`#mini-odp-name`);e&&e.focus()},100),r.addEventListener(`submit`,e=>{if(e.preventDefault(),!X.current)return;let t=r.querySelector(`#mini-odp-name`).value,a=r.querySelector(`#mini-odp-ports`).value,o=r.querySelector(`#mini-odp-desc`).value,s=r.querySelector(`#mini-odp-lat`).value,c=r.querySelector(`#mini-odp-lng`).value;n.post(`/admin/odps/save`,{name:t,latitude:s,longitude:c,total_ports:a,description:o},{onSuccess:()=>{i.closePopup()}})});let e=r.querySelector(`#mini-odp-gps-btn`);e&&e.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`Membaca GPS...`;try{let e=await ee(),t=r.querySelector(`#mini-odp-lat`),n=r.querySelector(`#mini-odp-lng`);t&&(t.value=e.latitude),n&&(n.value=e.longitude),V(e.latitude),U(e.longitude),i.flyTo([parseFloat(e.latitude),parseFloat(e.longitude)],17,{duration:.8}),u(`Koordinat GPS berhasil diambil.`,`success`)}catch(e){u(e.message||`Gagal membaca GPS perangkat.`,`error`)}finally{e.disabled=!1,e.textContent=`Ambil GPS Perangkat`}})}});let h=_?`https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png`:`https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png`;S.default.tileLayer(h,{attribution:`© OpenStreetMap`}).addTo(i);let g=S.default.divIcon({className:`custom-odp-marker`,html:`<div class="w-6 h-6 rounded-full bg-blue-500 border-2 border-white dark:border-zinc-950 flex items-center justify-center text-[8px] font-black text-white shadow-lg ring-2 ring-blue-500/25">ODP</div>`,iconSize:[24,24],iconAnchor:[12,12]}),v=e=>S.default.divIcon({className:`custom-customer-marker`,html:`<div class="w-3.5 h-3.5 rounded-full ${e===`active`?`bg-emerald-500 ring-emerald-500/35`:`bg-rose-500 ring-rose-500/35`} border border-white dark:border-zinc-950 shadow-md ring-2"></div>`,iconSize:[14,14],iconAnchor:[7,7]}),y={};e.forEach(e=>{let t=parseFloat(e.latitude),n=parseFloat(e.longitude);y[e.id]=[t,n],S.default.marker([t,n],{icon:g}).addTo(i).bindPopup(`
